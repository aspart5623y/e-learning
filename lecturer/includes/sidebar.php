...
<section class="bg-white shadow" id="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <li class="sidebar-item">
            <a href="<?php echo SITEURL ?>lecturer/index.php" class="sidebar-link <?php if ($page == 'dashboard'){echo 'active';} ?>">
                <!-- icon -->
        ...
        <!-- sidebar link -->
        <li class="sidebar-item">
            <a href="<?php echo SITEURL ?>lecturer/classroom.php" class="sidebar-link <?php if ($page == 'classroom'){echo 'active';} ?>">
                <!-- icon -->
        ...
        <!-- sidebar link -->
        <li class="sidebar-item">
            <a href="<?php echo SITEURL ?>lecturer/course.php" class="sidebar-link <?php if ($page == 'course'){echo 'active';} ?>">
                <!-- icon -->
        ...
        <!-- sidebar link -->
        <li class="sidebar-item">
            <a href="<?php echo SITEURL ?>lecturer/students.php" class="sidebar-link <?php if ($page == 'student'){echo 'active';} ?>">
                <!-- icon -->
        ...
        <!-- sidebar link -->
        <li class="sidebar-item">
            <a href="<?php echo SITEURL ?>lecturer/set-test.php" class="sidebar-link <?php if ($page == 'test'){echo 'active';} ?>">
                <!-- icon -->
                <i class="fas fa-laptop"></i>
                <!-- name -->
                <span class="sidebar-text">Set Text</span>
            </a>
        </li>
