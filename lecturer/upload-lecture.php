                        ...
                        <div class="card shadow-sm my-3 border-0">
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <?php 
                                        include "./php/upload-lecture.php";
                                    ?>

                                    <h5 class="font-weight-bold text-center my-4">Upload Lecture</h5>
                        
                                    <p class="text-danger text-center" id="lecture_error"><?php echo $error; ?></p>
                        
                                    <div class="form-group">
                                        <label for="">Title:</label>
                                        <input type="text" class="form-control" name="lecture_title" placeholder="Enter title of lecture" value="<?php echo $title; ?>">
                                    </div>
                        
                                    <div class="form-group">
                                        <label for="">Description:</label>
                                        <input type="text" class="form-control" name="lecture_desc" placeholder="Enter lecturer description" value="<?php echo $desc; ?>">
                                    </div>
                                    ...
                                    <div class="form-group my-3">
                                        <label for="">Lecture file:</label> <br>
                                        <input type="file" name="lecture_file"> <br>
                                        <small class="text-muted">(upload a zipped file only)</small>
                                    </div>
                        
                                    
                                    <div class="my-4">
                                        <button class="btn btn-primary w-100 py-3" name="addLectureBtn" type="submit">Submit</button>
                                    </div>
                                </form>
