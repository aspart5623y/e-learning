                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm my-3 border-0">
                                <div class="card-body text-center">
                                    ...
                                    <a href="<?php echo SITEURL ?>dashboard/classroom-lectures.php" class="stretched-link"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm my-3 border-0">
                                <div class="card-body text-center">
                                    ...
                                    <a href="<?php echo SITEURL ?>dashboard/classroom-assignment.php" class="stretched-link"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm my-3 border-0">
                                <div class="card-body text-center">
                                    ...
                                    <a href="<?php echo SITEURL ?>dashboard/ask-question.php" class="stretched-link"></a>
                                </div>
                            </div>
                        </div>
